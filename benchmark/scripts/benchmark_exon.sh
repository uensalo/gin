...
./benchmark_query_speed_vs_cached_query_length.sh ../res/graph/gencode.v40.fmdg 4 2 4 6 8 10 75 100 200 300 400 500 600 700 800 900 1000
./benchmark_query_speed_vs_cached_query_length.sh ../res/graph/gencode.v40.fmdg 6 2 4 6 8 10 75 100 200 300 400 500 600 700 800 900 1000
./benchmark_query_speed_vs_cached_query_length.sh ../res/graph/gencode.v40.fmdg 8 2 4 6 8 10 75 100 200 300 400 500 600 700 800 900 1000

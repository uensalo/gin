...
GetOptions(
    'i=s' => \$gfa_file,
    'o=s' => \$fmdg_file
) or die "Usage: $0 -i <input.rGFA> -o <output.FMDG>\n";

# Check if input and output files are provided
if (not defined $gfa_file or not defined $fmdg_file) {
    die "Usage: $0 -i <input.rGFA> -o <output.FMDG>\n";
}
...
# Write the FMDG file using the remapping
open my $fd, '>', $fmdg_file or die "Could not open FMDG file: $!\n";

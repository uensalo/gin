...
fmd_oimt_node_t *fmd_oimt_init_helper(fmd_imt_node_t *imt, fmd_graph_t *graph, fmd_vector_t *inverse_permutation, int_t *alphabet, int_t alphabet_size, int_t *c2e);
